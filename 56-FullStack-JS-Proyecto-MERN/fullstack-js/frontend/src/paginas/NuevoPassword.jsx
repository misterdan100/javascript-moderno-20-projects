...
const NuevoPassword = () => {
    ...
    useEffect(() => {
        ...
        comprobarToken();
    }, []); //* llaves para indicarle que se ejecute una sola vez
    ...
    return (
        <>
            <div>
                <h1 className='text-indigo-600 font-black text-6xl'>Reestablece tu Password y no piertas Acceso a <span className='text-black'>tus Pacientes</span></h1>
            </div>
