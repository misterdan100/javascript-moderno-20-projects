...
function buscarImagenes() {
    ...
    const key = '38133431-bad7238639e3939b68ffae7b5';
    ...
    fetch(url)
        ...
        .then( resultado => {
            ...
            mostrarImagenes(resultado.hits, terminoBusqueda);
        })
}

//! Generador que registra la cantidad de elemento de acuerdo a las paginas
...
function mostrarImagenes(imagenes, termino) {
    ...
    cantidad.innerHTML += `<p class="text-center text-lg text-white my-3 font-bold uppercase w-full">${imagenes.length} resultados para: ${termino}</p>`

    //* Iterar sobre las imagenes y hacer HTML
        ...
        resultado.innerHTML += `
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-2 mb-4">
                <div class="bg-white">
                    ...
                    <div class="p-4">
                        <p class="italic font-bold">${likes}<span class="font-light"> Likes</span></p>
                        <p class="italic font-bold">${views}<span class="font-light"> views</span></p>
